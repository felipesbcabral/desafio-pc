...
public class CreateDebtTitleSimpleRequest
{
    ...
    [Required(ErrorMessage = "Taxa de juros mensal é obrigatória")]
    ...
    [Range(1, 120, ErrorMessage = "Número de parcelas deve estar entre 1 e 120")]
